...
class Test_wode2():
    ...
    def test_wode_lishi(self):
        ...
        sleep(2)
        # 观看历史
        self.d(text=u"观看历史").click(timeout=20)
        sleep(2)
        # 过滤短视频
        self.d(resourceId="com.chinamobile.cloudapp:id/filter_short_video_icon").click(timeout=20)
        self.d(resourceId="com.chinamobile.cloudapp:id/filter_short_video_icon").click(timeout=20)
        sleep(2)
        # 编辑
        ...
        # 全选
        self.d(resourceId="com.chinamobile.cloudapp:id/home_cloud_edit").click(timeout=20)
        self.d(resourceId="com.chinamobile.cloudapp:id/delete_all_btn").click(timeout=20)
        self.d(resourceId="com.chinamobile.cloudapp:id/delete_all_btn").click(timeout=20)
        sleep(2)
        # 切换资讯
        self.d(resourceId="com.chinamobile.cloudapp:id/tv_his_tab1").click(timeout=20)
        sleep(2)
        # 切换电台
        self.d(resourceId="com.chinamobile.cloudapp:id/tv_his_tab3").click(timeout=20)
        sleep(2)
        self.d.press("back")
